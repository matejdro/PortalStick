...
public class PortalBlockDown extends GenericCubeCustomBlock {

	public PortalBlockDown(Plugin plugin) {
		super(plugin, "LowerPortalBlock", "http://drotar.zapto.org/Minecraft/blocks/portalDown.png", 16);

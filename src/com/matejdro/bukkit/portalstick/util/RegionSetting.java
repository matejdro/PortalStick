...
public enum RegionSetting {
	...
	GRILL_INVENTORY_CLEAR_EXCEPTIONS("grill-inventory-clear-exceptions", Arrays.asList(new String[]{"313"}), true),
	...
	PORTAL_BLOCKS("portallable-blocks", Arrays.asList(new Integer[]{42})),
	ALL_BLOCKS_PORTAL("all-blocks-allow-portals", false, true),
	UNIQUE_INVENTORY("unique-inventory", false, true),
	UNIQUE_INVENTORY_ITEMS("unique-inventory-items", Arrays.asList(new String[]{"280,1"}), true),
	...
	BLUE_GEL_VELOCITY_MULTIPLIER("blue-gel-horizontal-velocity-multiplier", 1.5),
